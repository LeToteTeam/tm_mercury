defmodule TM.Mercury.Reader.Version do
  ...
  defp format_software_field(reader),
    do:
      "#{format_version_field({:firmware, reader.firmware})}-#{
        format_version_field({:firmware_date, reader.firmware_date})
      }-BL#{format_version_field({:bootloader, reader.bootloader})}"
end
